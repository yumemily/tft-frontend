    ...
    <Grid container component="main" className={classes.root}>
      ...
      <Grid item xs={12} sm={8} md={5} component={Paper} elevation={6} square>
        <div className={classes.paper}>
          ...
          <form className={classes.form} Validate onChange={handleChange} onSubmit={handleLogin}>
            <TextField
              variant="outlined"
              margin="normal"
              required
            ...
            <Grid container>
              <Grid item xs>
                ...
                <Link to="/password-reset"className="sign-in-link">
                    Forgot password?
                </Link>
              </Grid>
              <Grid item>
                {/* <Link onClick={handleView}href="/login" variant="body2">
          ...
          <p className="text-center text-danger my-3" >{text}</p>
            <Box mt={5}>
              <Copyright />
            </Box>
          </form>
